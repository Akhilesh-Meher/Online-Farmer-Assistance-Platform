        ...
        <nav class="navbar">
            ...
            <ul>
                <li><a href="#features">features <i class="fa-solid fa-caret-down"></i></a>
                    <ul>
                        <li><a href="#"onclick="window.location.href='news.html'">news</a><br>
                            <a href="#" onclick="window.location.href='weather/index.html'">weather</a><br>
                        </li>
                    </ul>
                </li>
            </ul>
                    ...
                    <div class="right-side">
                        <div class="topic-text">Send us a message</div>
                            <p>If you have any work from me or any types of quries related to my tutorial, you can send me
                               ...
                               <form action="mailto:meherakhilesh@gmail.com" method="post" enctype="text/plain">
                                    <div class="inputBox">
